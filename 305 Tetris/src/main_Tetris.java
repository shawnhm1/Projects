...
public class main_Tetris extends Applet {
    ...
    private class TetrisPiece {
        ...
        /**
         * Will paste the color's information for this specific piece into the given grid
         */
        ...
        /**
         * No arguments needed, version assumes pasting into main Game Grid
         */
        public void paste() {
            paste(grid);
        }
        ...
        public void rotate() {
            //This will copy the piece's data into a temp Array
            for(int i=0; i<4; i++)
                for(int j=0; j<4; j++)
                    tmp_grid[i][j] = squares[i][j];
            //Copy back the rotated pieces 90 Degrees
            for(int i=0; i<4; i++)
                for(int j=0; j<4; j++)
        ...
        public void rotateBack() {
             ...
             * this of course assumes this call was preceded by
    ...
    public static void main(String[] args) {
        ...
        main_Tetris tetris = new main_Tetris();
        frame.add(tetris);
        tetris.init();
        tetris.start();
